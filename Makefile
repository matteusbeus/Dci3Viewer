...
OBJS = crt0.o main.o cdfh.o hw_md.o tools_a.o
FILES =
...
cd: $(TARGET).bin
	...
	cp -r images/* cd/images/
	genisoimage -sysid "SEGA SEGACD" -volid "DCI3VIEWER" -generic-boot $(BOOTBLOCK) -full-iso9660-filenames -o $(TARGET).iso cd
